...
| 引っ張って更新 | エピソード一覧とホームの両方で、上端から下に引くと新着を確かめ直す。エピソード一覧は開いたときと同じ差分の確認、ホームはフォロー中の全番組をまとめて確認（3本ずつ流す）。ホームは普段いっさい通信しないので、まとめて確かめられるのはこの操作だけ。見つかっても知らせは出さず、一覧と更新日が変わるだけ |
